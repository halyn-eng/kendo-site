  ...
  return (
    <div>
      ...
      <div id="k-terms" className="kendo-section active">
        ...
        <div className="kcard">
          <div className="ktag warn">応じ技</div>
          <div className="kterm-name">抜き面 技巧要點</div>
          <div className="kterm-body">
            <b>小手抜き面</b> — 對方剣先移向右手要打小手時，手腕微上抬後收，身體不用大退，讓對方打空，立刻踏み込み打面。<br/>
            <b>胴抜き面</b> — 對方剣先右橫移要打胴時，右腳微向左前斜移半步閃開，同時舉竹刀打面。
          </div>
          <div className="kflow">看起こり（剣先／肩／腰的預兆）→ 微幅閃避 → 同拍踏み込み → 打面 → 殘心</div>
          <div className="kterm-body" style={{marginTop:'6px'}}>關鍵是「先閃、再打」同一拍完成，不是閃完停頓才打。閃避幅度剛好讓對方竹刀擦不到即可，閃太大會拉開距離打不到面。</div>
        </div>
      ...
      <div id="k-errors" className="kendo-section">
        ...
        <div className="kcard">
          <div className="kterm-name">抜き面：躲過頭 / 閃太慢</div>
          <div className="kerr-grid">
            <div className="kerr-box bad"><div className="kerr-label">躲太多</div>退整步或大幅側移 → 打不到面</div>
            <div className="kerr-box bad"><div className="kerr-label">看竹刀才反應</div>等竹刀快到才閃 → 來不及反擊</div>
          </div>
          <div className="kerr-box good" style={{marginTop:'6px'}}><div className="kerr-label">正確</div>看起こり提前微幅閃避，閃跟打同一拍完成</div>
        </div>
        <div className="kcard">
